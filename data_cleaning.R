...
# Import raw data
p1 <- read_csv(here("data", "Used_EV_1.csv"))
p2 <- read_csv(here("data", "Used_EV_2.csv"))
p3 <- read_csv(here("data", "Used_EV_3.csv"))
...
p1 <- p1 %>% 
  ...
  select(session, time_sec_p1, zipcode, car_buyer, dc_resident)
